...
/**
  * взято https://github.com/akka/alpakka/blob/master/mongodb/src/main/scala/akka/stream/alpakka/mongodb/ObservableToPublisher.scala
  * так как оно все private =(
  * */
final class MongoPublisher[T](observable: mongoDB.Observable[T])
